...
const projectsWidgets = [
    {
        ...
        subCounter: [{ id: 1, counter: 155, suffix: "" }]
    },
    {
        id: 2,
        feaIcon: "dollar-sign", // Changed to a relevant icon for revenue
        ...
        subCounter: [{ id: 1, counter: 7522, suffix: "$" }] // Updated suffix to "$"
    },
    {
        id: 3,
        feaIcon: "user", // Changed to 'client' icon
        feaIconClass: "info",
        label: "Clients",
        badgeClass: "danger",
        icon: "ri-arrow-down-s-line",
        percentage: "10.35 %",
        caption: "Active clients this month",
        subCounter: [{ id: 1, counter: 120 }] // Updated id to be unique
    }
];
...
const activeProjects = [
    {
        id: 1,
        projectName: "Site 1 Solar Project",
        img: avatar1,
