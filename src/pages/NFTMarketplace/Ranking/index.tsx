...
const Ranking = () => {
    document.title = "Ranking | Skyfire - React Admin & Dashboard Template";
                    ...
                    <>
                        <div className="collection">
                            <div className="d-flex align-items-center">
                                <img src={collection.row.original.img} alt="" className="avatar-xs rounded-circle object-fit-cover me-2" /> <Link to="/apps-nft-item-details" className="text-body">{collection.row.original.collection}</Link>
                            </div>
                        </div>
                    </>
                ),
                        ...
                        <div className="col-lg-12">
                            <div className="card" id="contactList">
                                <div className="card-header border-0">
                                    <div className="d-flex align-items center">
                                        <h5 className="card-title mb-0 flex-grow-1">The top NFTs ranking on Skyfire</h5>
