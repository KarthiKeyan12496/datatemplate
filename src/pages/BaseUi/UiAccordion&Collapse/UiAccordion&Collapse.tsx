...
const UiAccordions = () => {
 // Default Accordion
    ...
    const [iconCol1, seticonCol1] = useState<boolean>(true);
    const [iconCol2, seticonCol2] = useState<boolean>(false);
    const [iconCol3, seticonCol3] = useState<boolean>(false);
    ...
    const [iconCol4, seticonCol4] = useState<boolean>(true);
    const [iconCol5, seticonCol5] = useState<boolean>(false);
    const [iconCol6, seticonCol6] = useState<boolean>(false);
    ...
    const [plusiconCol1, setplusiconCol1] = useState<boolean>(true);
    const [plusiconCol2, setplusiconCol2] = useState<boolean>(false);
    const [plusiconCol3, setplusiconCol3] = useState<boolean>(false);
    ...
    const [lefticonCol1, setlefticonCol1] = useState<boolean>(true);
    const [lefticonCol2, setlefticonCol2] = useState<boolean>(false);
    const [lefticonCol3, setlefticonCol3] = useState<boolean>(false);
    ...
    // Accordions Bordered
    const [borderCol1, setborderCol1] = useState<boolean>(true);
    const [borderCol2, setborderCol2] = useState<boolean>(false);
    const [borderCol3, setborderCol3] = useState<boolean>(false);
    ...
    // Nesting Accordions
    const [nestingCol1, setnestingCol1] = useState<boolean>(true);
    const [nestingCol2, setnestingCol2] = useState<boolean>(false);
    const [nestingCol3, setnestingCol3] = useState<boolean>(false);
    ...
    // level First Nesting
    const [anestingCol1, setanestingCol1] = useState<boolean>(true);
    const [anestingCol2, setanestingCol2] = useState<boolean>(false);
    ...
    const [bnestingCol1, setbnestingCol1] = useState<boolean>(false);
    ...
    const [a1nestingCol1, seta1nestingCol1] = useState<boolean>(true);
    ...
    const [fillCol1, setfillCol1] = useState<boolean>(true);
    ...
    const [fillCol4, setfillCol4] = useState<boolean>(true);
    const [fillCol5, setfillCol5] = useState<boolean>(false);
    const [fillCol6, setfillCol6] = useState<boolean>(false);
    ...
    document.title = "Accordions | Skyfire - React Admin & Dashboard Template";
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Accordion id="default-accordion-example" open={'1'}  toggle={toggle}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion id="default-accordion-example" flush  open={'1'} toggle={toggle}>
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingOne">
                                                    <button
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon accordion-secondary" id="accordionWithicon"  open={'1'}  toggle={toggle}>
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingOne">
                                                    <button
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="accordion-icon-none" id="accordionWithouticon" open={'1'}  toggle={toggle}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon-plus" id="accordionWithplusicon" open={'1'}  toggle={toggle}>
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionwithouticonExample1">
                                                    <button
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Accordion className="lefticon-accordion custom-accordionwithicon accordion-border-box" id="accordionlefticon"  open={'1'}  toggle={toggle}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon custom-accordion-border accordion-border-box accordion-success" id="accordionBordered" open={'1'}  toggle={toggle}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon accordion-border-box" id="accordionnesting" open={'1'}  toggle={toggle}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xxl={6}>
                                                <Accordion className="custom-accordionwithicon accordion-fill-success" id="accordionFill" open={'1'}  toggle={toggle}>
                                                    <AccordionItem>
                                            ...
                                            <Col xxl={6}>
                                                ...
                                                <Accordion className="custom-accordionwithicon accordion-flush accordion-fill-secondary" id="accordionFill2" open={'1'}  toggle={toggle}>
                                                    <AccordionItem>
