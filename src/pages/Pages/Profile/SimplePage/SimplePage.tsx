...
const SimplePage = () => {
    document.title = "Profile | Skyfire - React Admin & Dashboard Template";
                                                            ...
                                                            <Table className="table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="text-muted">daveadame@Skyfire.com</td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <Link to="#" className="fw-semibold">www.Skyfire.com</Link>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                ...
                                                <div className="acitivity-timeline">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2">added a new member to Skyfire
                                                                dashboard</p>
