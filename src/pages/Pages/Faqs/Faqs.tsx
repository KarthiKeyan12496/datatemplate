...
const Faqs = () => {
    ...
    const [col7, setcol7] = useState<boolean>(false)
    const [col8, setcol8] = useState<boolean>(false)

    const [col9, setcol9] = useState<boolean>(true)
    const [col10, setcol10] = useState<boolean>(false)
    const [col11, setcol11] = useState<boolean>(false)
    const [col12, setcol12] = useState<boolean>(false)
    ...
    document.title = "FAQs | Skyfire - React Admin & Dashboard Template";
