...
const CrmCompanies = () => {
    ...
    () => [
      {
        ...
        Cell: (cellProps: any) => {
          return <input type="checkbox" className="companyCheckBox form-check-input" value={cellProps.row.original.id} onChange={() => deleteCheckbox()} />;
        },
        id: '#',
      },
      {
          ...
          <>
            <div className="d-flex align-items-center">
              <div className="flex-shrink-0">
                {company.row.original.picture ? <img
                  src={company.row.original.picture}
  ...
  document.title = "Companies | Skyfire - React Admin & Dashboard Template";
  return (
    <React.Fragment>
