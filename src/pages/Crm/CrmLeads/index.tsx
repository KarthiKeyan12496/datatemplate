...
const CrmLeads = () => {
    ...
    () => [
      {
        ...
        Cell: (cellProps: any) => {
          return <input type="checkbox" className="leadsCheckBox form-check-input" value={cellProps.row.original.id} onChange={() => deleteCheckbox()} />;
        },
        id: '#',
      },
      {
  ...
  document.title = "Leads | Skyfire - React Admin & Dashboard Template";
